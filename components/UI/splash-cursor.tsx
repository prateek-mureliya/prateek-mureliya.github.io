...
type TSupportedFormat = { internalFormat: number; format: number } | null;
...
export default function SplashCursor({
  ...
  useEffect(() => {
    ...
    function getWebGLContext(canvas: HTMLCanvasElement) {
      ...
      let formatRGBA: TSupportedFormat;
      let formatRG: TSupportedFormat;
      let formatR: TSupportedFormat;
  ...
  return (
    <div className='fixed top-0 left-0 z-1000 pointer-events-none w-full h-full'>
      <canvas
        ref={canvasRef}
        id='fluid'
