...
export default function Header() {
  return (
    <header
      className={`absolute left-0 right-0 grid grid-cols-[1fr_auto] gap-3 py-1.5 px-3 border-b supports-backdrop-blur:bg-white/10 supports-backdrop-blur:dark:bg-black/10 backdrop-blur-md`}
      style={{
