...
export const MESSAGE_FIELD = "entry.824989131";

//social links and username
export const LINKEDIN_USERNAME = "prateek-mureliya";
export const LINKEDIN_URL = `https://www.linkedin.com/in/${LINKEDIN_USERNAME}`;

export const GITHUB_USERNAME = "prateek-mureliya";
export const GITHUB_URL = `https://github.com/${GITHUB_USERNAME}`;

export const INSTAGRAM_USERNAME = "mureliya";
