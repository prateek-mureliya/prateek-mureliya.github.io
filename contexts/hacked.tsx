...
export const HackedContextProvider = ({ children }: { children: ReactNode }) => {
  ...
  return <HackedContext.Provider value={{ isHacked, setIsHacked }}>{children}</HackedContext.Provider>;
};
...
export const useHackedContext = () => {
  ...
  if (!context) {
    throw new Error('useHackedContext must be used within a HackedContextProvider');
  }
